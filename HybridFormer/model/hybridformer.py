...
import os
from HybridFormer.utils.utils import Hypothesis

from .hybrid_decoder import Decoder , PosDecoder
from .encoder import Encoder
from HybridFormer.datamodule import vocab , label_make_muti
...
class HybridFormer(pl.LightningModule):
    def __init__(
        self,
        d_model: int,
        growth_rate: int,
